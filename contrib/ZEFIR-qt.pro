...
RESOURCES += src/qt/zefir.qrc src/qt/zefir_locale.qrc

TRANSLATIONS += src/qt/locale/zefir_bg.ts \
                src/qt/locale/zefir_de.ts \
                src/qt/locale/zefir_en.ts \
                src/qt/locale/zefir_es.ts \
                src/qt/locale/zefir_fi.ts \
                src/qt/locale/zefir_fr.ts \
                src/qt/locale/zefir_it.ts \
                src/qt/locale/zefir_ja.ts \
                src/qt/locale/zefir_pl.ts \
                src/qt/locale/zefir_pt.ts \
                src/qt/locale/zefir_ru.ts \
                src/qt/locale/zefir_sk.ts \
                src/qt/locale/zefir_sv.ts \
                src/qt/locale/zefir_vi.ts \
                src/qt/locale/zefir_zh_CN.ts \
                src/qt/locale/zefir_zh_TW.ts
