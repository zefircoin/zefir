...
ZEFIR-Project/ZEFIR repository.
...
Setup
---------
Configuring the github-merge tool for the ZEFIR repository is done in the following way:

    git config githubmerge.repository ZEFIR-Project/ZEFIR
...
A script to optimize png files in the ZEFIR
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_zefir: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_zefir: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_zefir: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_zefir: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
