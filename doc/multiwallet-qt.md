...
In order to support loading of multiple wallets in zefir-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zefir.cpp.
...
Changes to zefir.cpp
----------------------
zefir.cpp is the entry point into zefir-qt, and as such, will require some minor modifications to provide hooks for
