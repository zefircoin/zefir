Contributing to ZEFIR Core
============================

The ZEFIR Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ZEFIR Core project, and is not to be
confused with overall ZEFIR Network Protocol consensus changes.

Whether a pull request is merged into ZEFIR Core rests with the project merge
...
Patches that change ZEFIR consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZEFIR consensus, it must have been
...
The project leader is the release manager for each ZEFIR Core release.
