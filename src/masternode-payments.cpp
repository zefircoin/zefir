...
bool IsBlockValueValid(const CBlock& block, CAmount nExpectedValue,
	...
	//ACCEPT 1 NON STANDARD BLOCK AFTER: 
	if (pindexPrev->GetBlockHash() == uint256("e32385f9489d051b139e48296a2d08d70e5ef4e41fbc412d9047136dcbb8d3e4") && pindexPrev->nHeight == 245004)
		return true;
...
bool IsBlockPayeeValid(const CBlock& block, int nBlockHeight) {
	...
	const CTransaction& txNew = (nBlockHeight > Params().LAST_POW_BLOCK() ?
	...
	LogPrintf("SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT IS ACTIVE \n");
	return false;
	//LogPrint("masternode",
...
void FillBlockPayee(CMutableTransaction& txNew, CAmount nFees,
		bool fProofOfStake, bool fZZEFIRStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
	if (!pindexPrev)
		return;

	masternodePayments.FillBlockPayee(txNew, nFees, fProofOfStake, fZZEFIRStake);
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew,
		int64_t nFees, bool fProofOfStake, bool fZZEFIRStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
