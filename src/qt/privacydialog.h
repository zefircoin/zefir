...
public:
    ...
    void setZZefirControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzZEFIR_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzZEFIR_clicked();
    void on_pushButtonZZefirControl_clicked();
