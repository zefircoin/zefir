...
/* Zefir GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ZEFIR"
#define QAPP_ORG_DOMAIN "zefir.icu"
#define QAPP_APP_NAME_DEFAULT "ZEFIR-Qt"
#define QAPP_APP_NAME_TESTNET "ZEFIR-Qt-testnet"
