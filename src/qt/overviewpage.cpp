...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::ZEFIR)
    {
    }
...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, CAmount nZerocoinBalance, QString& sZEFIRPercentage, QString& szZEFIRPercentage)
{
    int nPrecision = 2;
    ...
    szZEFIRPercentage = "(" + QLocale(QLocale::system()).toString(dzPercentage, 'f', nPrecision) + " %)";
    sZEFIRPercentage = "(" + QLocale(QLocale::system()).toString(dPercentage, 'f', nPrecision) + " %)";
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    bool showZEFIRAvailable = settingShowAllBalances || pivAvailableBalance != nTotalBalance;
    bool showWatchOnlyZEFIRAvailable = watchOnlyBalance != nTotalWatchBalance;
    bool showZEFIRPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyZEFIRPending = watchUnconfBalance != 0;
    bool showZEFIRLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyZEFIRLocked = nWatchOnlyLockedBalance != 0;
    bool showImmature = settingShowAllBalances || immatureBalance != 0;
    bool showWatchOnlyImmature = watchImmatureBalance != 0;
    bool showWatchOnly = nTotalWatchBalance != 0;
    bool showzZEFIRAvailable = settingShowAllBalances || zerocoinBalance != matureZerocoinBalance;
    bool showzZEFIRnconfirmed = settingShowAllBalances || unconfirmedZerocoinBalance != 0;
    bool showzZEFIRImmature = settingShowAllBalances || immatureZerocoinBalance != 0;
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    // update the display unit, to not use the default ("ZEFIR")
    updateDisplayUnit();
}
