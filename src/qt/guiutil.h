...
/** Utility functions used by the ZEFIR Qt UI.
 */
namespace GUIUtil
{
...
// Render ZEFIR addresses in monospace font
...
// Parse "zefir:" URI into recipient object, return true on successful parsing
