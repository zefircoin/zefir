...
/** 
    ...
    ****Note - for ZEFIR we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of zefir coming in to a transaction
