...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ZEFIR features */
        {"zefir", "masternode", &masternode, true, true, false},
        {"zefir", "listmasternodes", &listmasternodes, true, true, false},
        {"zefir", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zefir", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zefir", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"zefir", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"zefir", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"zefir", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zefir", "masternodedebug", &masternodedebug, true, true, false},
        {"zefir", "startmasternode", &startmasternode, true, true, false},
        {"zefir", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zefir", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zefir", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zefir", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zefir", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zefir", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zefir", "mnbudget", &mnbudget, true, true, false},
        {"zefir", "preparebudget", &preparebudget, true, true, false},
        {"zefir", "submitbudget", &submitbudget, true, true, false},
        {"zefir", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zefir", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zefir", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zefir", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zefir", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zefir", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zefir", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zefir", "checkbudgets", &checkbudgets, true, true, false},
        {"zefir", "mnsync", &mnsync, true, true, false},
        {"zefir", "spork", &spork, true, true, false},
        {"zefir", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> zefir-cli " + methodname + " " + args + "\n";
}
